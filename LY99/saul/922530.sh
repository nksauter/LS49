...
# NO PSF:
srun -n 320 -c 2 dials.stills_process ../index_nks.phil input.glob=../917302/LY99_MPIbatch_*.img.gz

# WITH PSF:
#srun -n 320 -c 2 dials.stills_process ../index_nks.phil input.glob=../917162/LY99_MPIbatch_*.img.gz
