...
#SBATCH -t 01:15:00      # wall clock time limit
...
srun -n 1024 -c 2 libtbx.python $MODULES/LS49/adse13_196/revapi/LY99_batch.py noise=True psf=False attenuation=True context=kokkos_gpu
