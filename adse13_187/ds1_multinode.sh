#!/bin/bash -l
#SBATCH -q regular #special    # regular or special queue
#SBATCH -N 5          # Number of nodes
#SBATCH -t 06:30:00   # wall clock time limit
#SBATCH -J test_frame
#SBATCH -L SCRATCH    # job requires SCRATCH files
#SBATCH -C gpu
#SBATCH -A m1759      # allocation
#SBATCH -G 40          # devices total (not per node)
...
srun -n 40 -c 5 --ntasks-per-gpu=1 --cpu-bind=cores libtbx.python $MODULES/LS49/adse13_187/cyto_frame.py N_total=7534
