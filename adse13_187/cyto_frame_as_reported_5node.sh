...
#SBATCH -t 06:00:00   # wall clock time limit
#SBATCH -J test_frame
...
srun -n 80 -c 5 --ntasks-per-gpu=2 --cpu-bind=cores libtbx.python $MODULES/LS49/adse13_187/cyto_frame_as_reported.py N_total=7534
