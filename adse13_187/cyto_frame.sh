...
# srun -n 80 -c 1 libtbx.python $MODULES/LS49/adse13_196/test_mpi.py
...
srun -n 8 -c 10 --cpu-bind=cores --gpus-per-task=1 --gpu-bind=map_gpu:0,1,2,3,4,5,6,7 libtbx.python $MODULES/LS49/adse13_187/cyto_frame.py N_total=7534
