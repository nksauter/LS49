...
export ABC_GLOB=/global/cscratch1/sd/nksauter/proj-paper1/abc_coverage_pixel_refine_90percent/abcX%06d.pickle
...
LLG_evaluator.title=ox_red_32k_90p > ox_red_32k_90p.out 2>&1

#libtbx.python ../modules/LS49/ML_push/replot.py starting_model.preset.FE1=Fe_oxidized_model starting_model.preset.FE2=Fe_reduced_model N_total=32000 LLG_evaluator.enable_plot=True LLG_evaluator.plot_interpolation=True LLG_evaluator.max_calls=24 LLG_evaluator.title=ox_red_32k_90p
#convert -delay 12 -loop 0 *.png ox_red_32k_90p.gif
