...
# negative control
srun -n 1088 -c 8 libtbx.python ../modules/LS49/ML_push/new_global_fdp_refinery.py \
...
LLG_evaluator.title=ox_red_spoilHKL_50ka cohort=0 > ox_red_spoilHKL_50ka.out 2>&1
...
LLG_evaluator.title=red_red_50ka > red_red_50ka.out 2>&1
