...
export MODEL_MODE=coarse_ground_truth
export ABC_GLOB=/global/cscratch1/sd/nksauter/proj-paper1/work/abc_coverage_coarse_ground_truth/abcX%06d.pickle
...
LLG_evaluator.title=ox_red_32k_cgt_gt > ox_red_32k_cgt_gt.out 2>&1
# fill in the results for abc_coverage=coarse ground truth, starting model ox_red, method3
