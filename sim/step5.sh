#!/bin/bash -l
#SBATCH -N 24         # N=32 Use N nodes
#SBATCH -t 23:00:00  #Set wall clock time limit
#SBATCH -p regular   #Submit to the regular or debug or premium 'partition', or debug
#SBATCH -L SCRATCH   #Job requires $SCRATCH file system
#SBATCH -C haswell   #Use Haswell nodes
#SBATCH -A m1027     #lcls
#SBATCH --job-name=step5_3
...
srun -n 192 -c 8 libtbx.python ../modules/LS49/sim/step5_batch.py
