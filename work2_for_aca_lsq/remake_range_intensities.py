...
if __name__=="__main__":
  ...
  initial = remake_intensities_at_energy(7090)
  print ("%d keys in initial"%len(initial))

  result = {}
  for key in initial:
    result[key] = flex.double(1,initial[key])

  for energy in range(7091,7151):
  ...
  with (open("confirm_range_intensities_dict.pickle","wb")) as F:
