...
export N_SIM=42 # total number of images to simulate
export ADD_SPOTS_ALGORITHM=NKS # cuda or JH or NKS
export ADD_BACKGROUND_ALGORITHM=sort_stable # cuda or jh or sort_stable
export CACHE_FHKL_ON_GPU=False # "True" or "False" use single object per rank
